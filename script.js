    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יוסף שלום יזדי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'f9551c2f-cb86-42c7-8624-d0691e377830',
                    name: data.name || '',
                    email: data.email || '',
